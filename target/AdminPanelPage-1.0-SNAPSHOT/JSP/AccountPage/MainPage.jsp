...
<html>
    <head>
        ...
        </script><link rel="stylesheet" href="https://cdn.datatables.net/1.13.4/css/jquery.dataTables.min.css">
                        ...
                        <div class="order">
                            ...
                            <table id="example">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="/Account/View/<%=rs.getInt("Account_ID")%>">More</a>
                                    </td>
                                </tr>
                                <%
                                    }
