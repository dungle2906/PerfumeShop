                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="text-center">  
                                            ...
                                            <a onclick="return confirm('Do you want to make remove this Admin?');" href="/Admin/DeleteAdmin/<%=rs.getInt("Account_ID")%>" class="button-1" role="button" ><i class="fa-solid fa-trash"></i></a>
                                        </div>
                                    </td>
                                </tr> 
                            </tbody>
