...
public class Authentication implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            try {
                if (IsCookieAvailable(httpRequest)) {
                    httpRequest.setAttribute("fullname", GetCookie(httpRequest));
                    int ID = dao.GetIDFromFullname(GetCookie(httpRequest));
                    ...
                    if (username != null) {
                        httpRequest.setAttribute("fullname", username);
                        int ID = dao.GetIDFromFullname(username);
                        httpRequest.setAttribute("ID", ID);
                    }
    ...
    public String GetCookie(HttpServletRequest request) throws IOException, jakarta.servlet.ServletException {
        String name = null;
        Cookie[] cookies = request.getCookies();
        if (cookies != null) {
            try {
